        ...
        <div className="flex flex-col h-[100%] justify-between">
          <div className="flex flex-col">
            <div className="flex flex-col pb-[2rem]">
              <div className="flex text-xl font-bold pb-[2rem] capitalize">
                ...
                <div className="pr-[0.5rem]">
                  <span> {`${currentUser ? currentUser.userFName : ""}`}</span>
                </div>
                <div>
                  <span> {`${currentUser ? currentUser.userLName : ""}`}</span>
                </div>
              </div>
          ...
          <div className="flex w-[100%] items-center justify-center">
            <div className="w-[24rem] flex justify-center">
              <ButtonLink href={"/join/enroll-your-child"} label="SIGN OUT" color="orange" />
            </div>
          </div>
        </div>
      </div>
